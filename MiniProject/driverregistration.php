                    ...
                    <form method="post" action="display.php">
                        <div class="row">
                            <div class="col-sm-12">
                             ...
                             <div class="col-sm-12">
                                 <input class="textarea" placeholder="Driver number" type="number" name="Dno">
                            </div>
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Age" type="number" name="Age">
                            </div>
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Salary" type="number" name="Salary">
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <a href="updatedriver.php"><button class="send">Update</a></button><br>
                                <a href="displaydrivers.php"><button class="send">See List</a></button>
